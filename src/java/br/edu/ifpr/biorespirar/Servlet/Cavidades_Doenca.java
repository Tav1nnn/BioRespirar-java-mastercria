 ...
 * @author otavio
 */
@WebServlet(name = "Cavidades_Doenca", urlPatterns = {"/Cavidades_Doenca"})
public class Cavidades_Doenca extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (sessao != null && sessao.getAttribute("autenticado") != null
           ...
           request.getRequestDispatcher("WEB-INF/cavidadesDoencas.jsp").
