 ...
 * @author otavio
 */
@WebServlet(name = "Cavidades_Informacoes", urlPatterns = {"/Cavidades_Informacoes"})
public class Cavidades_Informacoes extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (sessao != null && sessao.getAttribute("autenticado") != null
           ...
           request.getRequestDispatcher("WEB-INF/cavidadesInformacoes.jsp").
