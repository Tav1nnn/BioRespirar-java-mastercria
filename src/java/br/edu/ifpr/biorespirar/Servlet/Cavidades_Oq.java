 ...
 * @author otavio
 */
@WebServlet(name = "Cavidades_Oq", urlPatterns = {"/Cavidades_Oq"})
public class Cavidades_Oq extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (sessao != null && sessao.getAttribute("autenticado") != null
           ...
           request.getRequestDispatcher("WEB-INF/cavidades_Oq.jsp").
