 ...
 * @author otavio
 */
@WebServlet(name = "CavidadesNasais", urlPatterns = {"/CavidadesNasais"})
public class CavidadesNasais extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (sessao != null && sessao.getAttribute("autenticado") != null
             ...
             request.getRequestDispatcher("WEB-INF/cavidadesNasais.jsp").
